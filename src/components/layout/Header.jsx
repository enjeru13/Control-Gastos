      ...
      <div className="flex items-center justify-between px-4 py-4 max-w-3xl mx-auto">
        <div className="flex items-center gap-3">
          <button
            ...
            className="w-10 h-10 rounded-full bg-gradient-to-br from-primary to-tertiary-container flex items-center justify-center text-on-primary font-bold text-sm overflow-hidden shrink-0 hover:ring-2 hover:ring-primary/30 transition-all active:scale-95"
