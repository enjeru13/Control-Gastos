...
export default function Login() {
  ...
  return (
    <div
      ...
      style={{ background: 'linear-gradient(135deg, #f9f9ff 0%, #e7eeff 100%)' }}
    >
        ...
        >
          ...
          <header className="text-center flex flex-col items-center gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-on-surface-variant">Ingresa tus datos para continuar</p>
            </div>
          </header>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="relative">
                <Mail size={18} className="absolute left-3 top-1/2 -translate-y-1/2 text-outline pointer-events-none" />
                <input
                  id="email"
                  type="email"
                  required
            ...
            <div className="flex flex-col gap-2">
              ...
              <div className="relative">
                <Lock size={18} className="absolute left-3 top-1/2 -translate-y-1/2 text-outline pointer-events-none" />
                <input
                  id="password"
          ...
          <p className="text-sm text-on-surface-variant text-center">
            ...
            <Link to="/registro" className="text-sm font-bold text-primary hover:underline">
              Regístrate
            </Link>
          </p>
        </div>
