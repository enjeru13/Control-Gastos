...
function SettingRow({ icon: Icon, iconBg, label, subtitle, trailing, onClick, danger = false, divider = true }) {
  return (
    <div
      onClick={onClick}
      className={[
        ...
        danger ? 'hover:bg-error-container/20' : onClick ? 'hover:bg-surface-container-low' : '',
      ].join(' ')}
    >
      <div className="flex items-center gap-4">
        <div className={`w-10 h-10 rounded-full flex items-center justify-center shrink-0 ${iconBg ?? 'bg-secondary-container/30'}`}>
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end justify-center" onClick={onClose}>
      ...
      >
        ...
        <h3 className="text-base font-bold text-on-surface mb-4">Moneda Principal</h3>
    ...
    <div className="flex flex-col gap-8">
      ...
      <section className="bg-surface rounded-2xl shadow-card border border-surface-container p-6 flex flex-col sm:flex-row items-center gap-5">
        ...
        <div className="relative shrink-0">
          <div className="w-20 h-20 rounded-full bg-gradient-to-br from-primary to-tertiary-container flex items-center justify-center text-on-primary text-2xl font-bold shadow-card">
            {initials || 'U'}
          </div>
          <button
      ...
      <section className="flex flex-col gap-2">
        ...
        <div className="bg-surface rounded-2xl shadow-card border border-surface-container overflow-hidden">
          <SettingRow
            ...
            trailing={<ChevronRight size={16} className="text-on-surface-variant" />}
          />
          <SettingRow
            icon={Fingerprint}
            label="Biometría"
      ...
      <section className="flex flex-col gap-2">
        ...
        <div className="bg-surface rounded-2xl shadow-card border border-surface-container overflow-hidden">
          <SettingRow
            ...
            divider={false}
            trailing={<Toggle checked={alerts} onChange={setAlerts} disabled />}
          />
        </div>
      </section>
      ...
      <section className="flex flex-col gap-2">
        ...
        />
        <p className="text-[10px] text-on-surface-variant px-1">
          Formatos soportados: .csv, .xlsx — Descarga el historial desde tu banco
        </p>
      </section>
